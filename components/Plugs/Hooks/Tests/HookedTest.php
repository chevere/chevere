...
namespace Chevere\Components\Plugs\Hooks\Tests;
...
use Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookable;
use Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookableNoRegister;
use Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookableWithoutHooks;
...
final class HookedTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->plugs = new Plugins(
            (new ClassMap)
                ->withPut(
                    'Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookable',
                    $hooksPath . 'Chevere/Components/Hooks/Tests/TestHookable/hooks.php'
                )
                ->withPut(
                    'Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookableWithCorruptedHooks',
                    $hooksPath . 'Chevere/Components/Hooks/Tests/MyHookableWithCorruptedHooks/hooks.php'
                )
                ->withPut(
                    'Chevere\Components\Plugs\Hooks\Tests\_resources\TestHookableWithMissingHooks',
                    'error.php'
                )
        );
    }
